...
Каждый цикл, бот будет улучшать столько навыков, сколько указано в параметре **SKILLS_COUNT**. По умолчанию 5. В первую очередь, выбираются наиболее выгодные навыки.
