...
Каждый цикл, бот будет улучшать столько навыков для прибыли, сколько указано в параметре **SKILLS_COUNT**. По умолчанию 10. В первую очередь, выбираются наиболее выгодные навыки. Каждый цикл, бот будет улучшать каждый навык добычи на 1 уровень, пока уровень не достигнет указанного в **MINING_SKILLS_LEVEL**. Укажите 0, если вам не нужно улучшать навыки добычи.
